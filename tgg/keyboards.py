...
def get_levels_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(text="📊 Мой уровень", callback_data="my_level"), width=1
    )
    builder.row(
    ...
    builder.row(
        InlineKeyboardButton(text="📋 Все уровни", callback_data="all_levels"), width=1
    )
    builder.row(
        InlineKeyboardButton(
...
def get_level_info_keyboard(
    level_number: int, is_current: bool = False, can_upgrade: bool = False
):
    ...
    if can_upgrade and not is_current:
        builder.row(
            InlineKeyboardButton(
                text="⬆️ Повысить уровень",
                callback_data=f"upgrade_from_info_{level_number}",
            ),
            width=1,
        )
...
def get_upgrade_confirmation_keyboard(level_number: int, price: int):
    ...
    builder.row(
        InlineKeyboardButton(
            text="✅ Подтвердить",
            callback_data=f"confirm_upgrade_{level_number}_{price}",
        ),
...
def get_level_leaderboard_keyboard():
    ...
    builder.row(
        InlineKeyboardButton(text="🔙 Назад", callback_data="level_menu"), width=1
    )
...
def get_admin_main_keyboard():
    ...
    builder.row(
        ...
        InlineKeyboardButton(
            text="⚡ Управление удачей", callback_data="admin_luck_menu"
        ),
        width=2,
    )
    builder.row(
        InlineKeyboardButton(
            text="🎚️ Управление уровнями", callback_data="admin_levels_menu"
        ),
...
def get_force_result_keyboard():
    """Клавиатура для выбора принудительного результата"""
    builder = InlineKeyboardBuilder()
...
def get_url_keyboard(text: str, url: str, back_callback: str = "back_to_main"):
    ...
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(text=text, url=url), width=1)
    builder.row(
        InlineKeyboardButton(text="🔙 Назад", callback_data=back_callback), width=1
    )
    return builder.as_markup()
