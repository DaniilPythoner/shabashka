...
# Импорт обработчиков
try:
    from handlers import user, admin, http_bind, admin_game_control

    logger.info("✅ Обработчики импортированы")
    logger.info(f"   - user.py: загружен")
    logger.info(f"   - admin.py: загружен")
    logger.info(f"   - http_bind.py: загружен")
    logger.info(f"   - admin_game_control.py: загружен")
except ImportError as e:
...
async def main():
    ...
    try:
        ...
        logger.info("   - user.router: подключен")
        logger.info("   - admin.router: подключен")
        logger.info("   - http_bind.router: подключен")
        logger.info("   - admin_game_control.router: подключен")
